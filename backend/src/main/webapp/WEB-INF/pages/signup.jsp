...
<div class="d-flex flex-column align-items-center">
    ...
    <c:choose>
        <c:when test="${not empty msg}">
            <div class="w-50 alert alert-danger d-flex align-items-center mt-3" role="alert">
    ...
    <form:form cssClass="w-50" modelAttribute="user" method="post" action="">
        <div class="mb-3 mt-3">
            <label for="ln" class="form-label">Họ:</label>
            <form:input path="lastName" type="text" class="form-control" name="ln" />
        </div>
        <div class="mb-3 mt-3">
            <label for="fn" class="form-label">Tên:</label>
            <form:input path="firstName" type="text" class="form-control" name="fn" />
        </div>
        <div class="mb-3 mt-3">
