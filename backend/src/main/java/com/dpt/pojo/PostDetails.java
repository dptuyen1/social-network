...
@NamedQueries({
    ...
    @NamedQuery(name = "PostDetails.findById", query = "SELECT p FROM PostDetails p WHERE p.id = :id")})
public class PostDetails implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PostDetails)) {
            return false;
        }
        PostDetails other = (PostDetails) object;
    ...
    public String toString() {
        return "com.dpt.pojo.PostDetails[ id=" + id + " ]";
    }
