...
const Post = ({ props }) => {
    ...
    useEffect(() => {
        const loadComments = async () => {
            let res = await commentService.loadComments(props.id);
            setComments(res);
        };
            ...
            <div className="shadow-sm px-4 py-3 my-3 bg-white rounded w-50">
                ...
                <Form className="d-flex mt-3 align-items-center gap-2">
                    ...
                    <Form.Group className="w-100">
                        <Form.Control className="bg-light" type="text" placeholder="Hãy viết gì đó..." />
                    </Form.Group>

                    <Button variant="primary" type="submit" value={button}>
