                ...
                <div className="post__function">
                    ...
                    <div className="row gap-2 py-2">
                        <Tippy
                            interactive
                            render={(attrs) => (
                                <div className="reaction-icons bg-white px-2 rounded-circle" tabIndex="-1" {...attrs}>
                                    <button className="btn reaction-icon">
                                        <img
                                            className="p-1 img-40 rounded-circle border border-dark border-opacity-10 icon-img"
                                            src="/logo192.png"
                                            alt="Logo"
                                        />
                                    </button>
