                        ...
                        return (
                            <div className="card mt-4 shadow-sm p-2" style={{ width: '30rem' }} key={post.id}>
                                ...
                                <div className="post-comment d-flex align-items-center">
                                    ...
                                    <input type="text" className="form-control my-2" onChange={inputIsNotEmpty}></input>
                                    <button type="submit" className="btn btn-primary ms-1 h-auto disabled">
