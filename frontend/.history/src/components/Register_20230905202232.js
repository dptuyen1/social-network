...
const Register = () => {
    ...
    const register = (e) => {
        ...
        const process = async () => {
            let status = existedUser(user.username);
        ...
        <>
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    ...
                    {loading.toString() === 'true' && <Spinner animation="border" variant="secondary" />}
                    <Form>
                ...
                <Modal.Footer>
                    <Button variant="success" className="w-100" type="button" onClick={(e) => register(e)}>
                        Đăng ký
                    </Button>
                </Modal.Footer>
            </Modal>
