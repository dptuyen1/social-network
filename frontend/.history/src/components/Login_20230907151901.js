...
const Login = () => {
    ...
    return (
        <>
            ...
            <ToastContainer position="top-end" className="p-3" style={{ zIndex: 1 }}></ToastContainer>
            <Toast show={showA} onClose={toggleShowA}>
                <Toast.Header>
                    <FontAwesomeIcon icon={faTriangleExclamation} className="me-2" />
                    <strong className="me-auto">Thông báo</strong>
                </Toast.Header>
                <Toast.Body>Tài khoản của bạn đã bị khóa, vui lòng liên hệ quản trị viên để được mở khóa</Toast.Body>
            </Toast>
        </>
    );
};
