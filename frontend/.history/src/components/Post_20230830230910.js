            ...
            <div className="shadow-sm px-4 py-3 mb-5 bg-white rounded">
                <div className="d-flex justify-content-between">
                    <div className="d-flex gap-3">
                        <img
                            className="p-1 img-md rounded-circle border border-dark border-opacity-10"
                            src="/logo192.png"
                            alt="Logo"
                        />
                ...
                <div className="comments my-2">
                    <div className="d-flex gap-3 mb-2">
                        <img
                            className="p-1 img-xsm rounded-circle border border-dark border-opacity-10"
                            src="/logo192.png"
                            alt="Logo"
                        />
                        ...
                        <div className="p-2 bg-light rounded">
                            <h6>Người dùng</h6>
                            <p>Bình luậnBình luậnBình luậnBình luậnBình luận...</p>
                        </div>
                    </div>
                </div>
            </div>
