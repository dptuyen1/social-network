        ...
        return (
            <>
                <div className="container">
                    <div className="card shadow-sm p-2 m-auto my-2" style={{ width: '30rem' }}>
                        <div className="post-header d-flex align-items-center">
                            ...
                            <div className="post-comment d-flex align-items-cente w-100">
                                <input
                                    type="text"
                        ...
                        return (
                            <div className="card shadow-sm p-2 m-auto my-2" style={{ width: '30rem' }} key={post.id}>
                                <div className="post-header d-flex">
                                    <img className="rounded-circle me-3" src="" alt="" style={imgStyle}></img>
