            ...
            <div className="shadow-sm px-4 py-3 mb-5 bg-white rounded">
                ...
                <div className="">
                    ...
                    <div className="row gap-2 py-2">
                        <div className="btn btn-light col d-flex align-items-center justify-content-center gap-3 reaction-parent">
                            <FontAwesomeIcon icon={faThumbsUp} />
                            <p className="mb-0">Thích</p>

                            <div className="reaction-menu">
                                <button className="btn btn-light hover-zoom">
                                    <img className="img-xsm rounded-circle w-100" src="/logo192.png" alt="Logo" />
                                </button>

                                <button className="btn btn-light">
                                    <img className="img-xsm rounded-circle" src="/logo192.png" alt="Logo" />
                                </button>
