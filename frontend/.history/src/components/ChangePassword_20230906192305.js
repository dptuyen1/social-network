...
const ChangePassword = () => {
    ...
    const changePassword = (e) => {
        ...
        if (currentPassword !== '' && newPassword !== '' && confirmPassword !== '') {
            if (currentPassword === newPassword) setMsg('Mật khẩu mới phải khác mật khẩu hiện tai!');
            else {
                if (confirmPassword === newPassword) process();
                else setMsg('Mật khẩu mới không khớp!');
            }
