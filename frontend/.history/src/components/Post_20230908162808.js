                ...
                <div className="post__function">
                    ...
                    <div className="row gap-2 py-2">
                        ...
                        >
                            ...
                            <div className="col d-flex align-items-center justify-content-center gap-3 text-primary">
                                {details.map((detail) => (
                                    <div
                                        key={detail.id}
                                        className="btn btn-light col d-flex align-items-center justify-content-center gap-3 text-primary"
                                    >
                                        {/* <FontAwesomeIcon icon={faThumbsUp} /> */}
